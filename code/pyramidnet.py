### Taken from: https://github.com/dyhan0920/PyramidNet-PyTorch/blob/master/PyramidNet.py
...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        if residual_channel != shortcut_channel:
            padding = torch.autograd.Variable(torch.cuda.DoubleTensor(batch_size, residual_channel - shortcut_channel, featuremap_size[0], featuremap_size[1]).fill_(0)) 
...
class PyramidNet(nn.Module):
    ...
    def __init__(self, num_classes, depth, alpha, bottleneck=False, dataset='cifar10'):
